...
namespace Elasticsearch.Net
{
	...
	public static class KnownEnums
	{
		...
		static KnownEnums()
		{
			...
			EnumStringResolvers.TryAdd(typeof(Order), (e) => GetStringValue((Order)e));
		...
		public static string GetStringValue(this Order enumValue)
		{
			switch (enumValue)
			{
				case Order.Asc:
			...
			throw new ArgumentException($"'{enumValue.ToString()}' is not a valid value for enum 'Order'");
		}
